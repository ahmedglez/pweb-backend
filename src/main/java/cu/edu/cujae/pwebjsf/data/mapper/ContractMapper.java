    ...
    @Mappings(
            {
                    ...
                    @org.mapstruct.Mapping(source = "tourist.code", target = "codeTourist"),
                    @org.mapstruct.Mapping(source = "tourist", target = "tourist"),
                    @org.mapstruct.Mapping(source = "car.code", target = "codeCar"),
                    @org.mapstruct.Mapping(source = "car", target = "car"),
                    @org.mapstruct.Mapping(source = "driver.code", target = "codeDriver"),
                    @org.mapstruct.Mapping(source = "driver", target = "driver"),
                    @org.mapstruct.Mapping(source = "bill.code", target = "codeBill"),
                    @org.mapstruct.Mapping(source = "bill", target = "bill"),
                    @org.mapstruct.Mapping(source = "payment.code", target = "codePayment"),
